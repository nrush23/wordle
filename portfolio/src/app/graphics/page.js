    ...
    <div className="font-sans grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20">
      ...
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        ...
        <ol className="font-mono list-inside text-sm/6 text-center sm:text-left grid grid-cols-3 gap-6">
          <Assignment path={`${prefix}/graphics/hw1/`} name={"HW 1: Pong"} image={`${prefix}/hw1/pong.png`}></Assignment>
          <Assignment path={`${prefix}/graphics/hw2/`} name={"HW 2: Plinko"} image={`${prefix}/hw2/plinko.png`}></Assignment>
          ...
          <Assignment path={`${prefix}/graphics/hw10/`} name={"HW 10: Gallery"} image={`${prefix}/hw10/gallery.png`}></Assignment>
          <Assignment path={`${prefix}/graphics/final/`} name={"Durg's Durgers: The Final"}></Assignment>
        </ol>
      </main>
    </div>
  );
